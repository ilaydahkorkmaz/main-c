                    ...
                    <div className="inner-footer">
                        <div className="logo-text">
                            <svg width="66" height="23" viewBox="0 0 66 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M28.8035 6.312L21.8195 22.872H18.3875L20.6195 17.712L15.7955 6.312H19.2035L21.6035 12.408L22.2995 14.592L22.9715 12.408L25.3715 6.312H28.8035Z" fill="white" />
                            ...
                            <p>Biz, Portland'da bulunan bir konut iç mekan tasarım firmasıyız. Boutique stüdyomuz daha fazlasını sunuyor.</p>
                        </div>
                        <div className="text-container">
                            <div className="services">
                                ...
                                <p>Hediye kartları</p>
                                <p>Kredi ve ödeme</p>
                                <p>Servis sözleşmeleri</p>
                                <p>Nakitsiz hesap</p>
                                <p>Ödeme</p>
                            </div>
                            <div className="services">
                                <h3>Alicıya Destek</h3>
                                <p>Siparişi bul</p>
                                <p>Teslimat şartları</p>
                                <p>Ürün değişimi ve iade</p>
                                <p>Garanti</p>
